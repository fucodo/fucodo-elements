class PasskeyRegister extends HTMLElement {
  ...
  _render() {
    ...
    // Hinweis-Reihe (zeigt, dass Attribute genutzt werden)
    ...
    // Allow custom button content via a named slot
    const actionSlot = document.createElement('slot');
    actionSlot.name = 'action';
    actionSlot.textContent = 'Passkey registrieren'; // fallback label
