class LoadingAction extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this._onClick = (e) => {
            ...
            // Bei <a> Navigation unterbinden, solange "loading"
            ...
            this._t = setTimeout(() => {
                ...
                // Event am <loading-action> selbst feuern (bubbled)
    ...
    _setDisabled(el, state) {
        if (el.tagName === 'BUTTON' || 'disabled' in el) {
            ...
            if (state) el.setAttribute('data-disabled', 'true'); else el.removeAttribute('data-disabled');
        }
