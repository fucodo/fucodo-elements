(() => {
  // packages/fucodo-tabs-simple/style.scss
...
@media (max-width: 640px) {
  ...
  // packages/fucodo-tabs-simple/index.js
  var FucodoTabs = class extends HTMLElement {
    ...
    _getPanels() {
      return this._slot.assignedElements({ flatten: true }).filter((el) => el.nodeType === Node.ELEMENT_NODE);
    }
    _render() {
